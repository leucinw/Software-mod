...
try:
    from forcebalance.tinkerio import AbInitio_TINKER, Vibration_TINKER, BindingEnergy_TINKER, Moments_TINKER, Interaction_TINKER, MinimumMatch_TINKER, Liquid_TINKER, Solvation_TINKER
except:
    logger.warning(traceback.format_exc())
...
Implemented_Targets = {
    ...
    'MINIMUMMATCH_TINKER':MinimumMatch_TINKER,
    ...
    'SOLVATION_TINKER':Solvation_TINKER,
